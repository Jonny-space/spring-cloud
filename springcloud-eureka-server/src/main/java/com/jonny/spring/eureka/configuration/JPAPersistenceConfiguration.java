package com.jonny.spring.eureka.configuration;
...
@EnableJpaRepositories(basePackages = "com.jonny.spring.eureka.repository" )//启用JPA资源库并指定资源库接口位置
@EntityScan(basePackages = "com.jonny.spring.eureka.entity")//指定实体的位置
